...
def valid_moves(
    ...
    """Return list of valid move locations for a given piece."""
...
def valid_captures(
    ...
    """Return list of valid capture locations for a given piece."""
    valid_captures: list[tuple[int, int]] = []
    ...
    for direction_row, direction_column in directions:
        ...
        if (
            ...
            valid_captures.append((new_row, new_col))
